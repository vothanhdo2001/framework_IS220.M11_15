...
namespace WebMusic_Auth.Controllers
{
    public class SongController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MId,Song,Author,Lyrics,Files,Photo")] SongModel songModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MId,Song,Author,Lyrics,Files,Photo")] SongModel songModel)
        {
            if (id != songModel.MId)
            {
                return NotFound();
