...
namespace WebMusic.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CoId,UsId,MId,Content,CoStatus,CoDate")] CommentsModel commentsModel)
        {
            ...
            ViewData["UsId"] = new SelectList(_context.UsersModel, "UsId", "UsId", commentsModel.UsId);
            return View(commentsModel);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CoId,UsId,MId,Content,CoStatus,CoDate")] CommentsModel commentsModel)
        {
